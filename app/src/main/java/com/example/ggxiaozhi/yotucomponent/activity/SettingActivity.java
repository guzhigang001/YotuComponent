 ...
 * 网络配置Activity
 */
public class SettingActivity extends BaseAvtivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        int currentSetting = SPManager.getInstance().getInt(SPManager.VIDEO_TYPE, 1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.alway_layout:
                SPManager.getInstance().putInt(SPManager.VIDEO_TYPE, 0);
            ...
            case R.id.wifi_layout:
                SPManager.getInstance().putInt(SPManager.VIDEO_TYPE, 1);
            ...
            case R.id.close_layout:
                SPManager.getInstance().putInt(SPManager.VIDEO_TYPE, 2);

...
package com.example.ggxiaozhi.yotucomponent.zxing.decode;
...
import com.example.ggxiaozhi.yotucomponent.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.auto_focus) {
            ...
            BeepManager manager = new BeepManager(activity);
